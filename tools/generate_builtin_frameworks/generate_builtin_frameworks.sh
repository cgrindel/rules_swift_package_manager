...
$(echo "${macos_swift_modules}" | format_as_go_list_item)
)
...
$(echo "${ios_swift_modules}" | format_as_go_list_item)
)
...
$(echo "${tvos_swift_modules}" | format_as_go_list_item)
)
...
$(echo "${watchos_swift_modules}" | format_as_go_list_item)
)
EOF
)"
