...
def _list_files_under(
    ...
    # The starting path will be prefixed to the results. If the starting path as dot (.) or the
    # current directory, the prefix for the results will be `./`. We will remove it.
