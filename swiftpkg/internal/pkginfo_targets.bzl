...
_objc_resource_bundle_accessor_suffix = "_objc_resource_bundle_accessor"
...
def _objc_resource_bundle_accessor_label_name(target_name):
    ...
    """
    return target_name + _objc_resource_bundle_accessor_suffix
...
def make_pkginfo_targets(bazel_labels):
    ...
    return struct(
        ...
        objc_resource_bundle_accessor_label_name = _objc_resource_bundle_accessor_label_name,
