...
* [](#quickstart)
  * [](#1-enable-bzlmod)
  * [rules\_swift\_package\_manager \.](https://github.com/cgrindel/rules_swift_package_manager)
    * [](#bzlmod-configure-your-modulebazel)
    * [](#legacy-add-declarations-to-your-workspace-file)
  * [](#3-create-a-minimal-packageswift-file)
  * [](#4-add-gazelle-targets-to-buildbazel-at-the-root-of-your-workspace)
  ...
  * [](#8-check-in-some-generated-files)
    * [](#bzlmod-check-in-packageresolved-swift_deps_indexjson-and-modulebazel)
    * [](#legacy-check-in-packageresolved-swift_deps_indexjson-and-swift_depsbzl)
  * [](#9-start-coding)
* [](#tips-and-tricks)
* [](#future-work)
<!-- MARKDOWN TOC: END -->
