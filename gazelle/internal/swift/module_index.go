...
func (mi *ModuleIndex) IndexRepoRule(r *rule.Rule, repoRoot string) error {
	var err error
	switch r.Kind() {
	case HTTPArchiveRuleKind:
		err = mi.indexHTTPArchive(r, repoRoot)
	}
	return err
}

func (mi *ModuleIndex) indexHTTPArchive(r *rule.Rule, repoRoot string) error {
